...
if ($empresa->verempresa()) {
    ...
    <div class="bg-white rounded shadow-lg p-5">
        <h3>Dados da sua conta</b></h3>
        <form action="../controle/editarConta.php" method="post" enctype="multipart/form-data">
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-12 col-md-5">
                    ...
                    placeholder="Você pode alterar em Usuário -> Alterar senha." readonly>
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="col-12 mb-3">
                    <div class="custom-file">
                        ...
                        <p class="pt-1 text-danger">*Extensões permitidas: jpg, jpeg e png.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center">
                <a href="painel.php" class="botao botao-vermelho botao-grande mr-1">
